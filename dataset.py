...
class Dataset(object):
    ...
    def __init__(self,
        ...
        self.setup_base_folder = os.path.join(base_folder, 'setup').replace('\\','/')
        self.video_frame_list_file_name = os.path.join(self.setup_base_folder, 'frames.csv').replace('\\','/')
        self.train_id_list_file_name = os.path.join(self.setup_base_folder, train_id_file).replace('\\','/')
        self.val_id_list_file_name = os.path.join(self.setup_base_folder, val_id_file).replace('\\','/')
        self.seg_mask_file_name = os.path.join(self.setup_base_folder, 'seg_masks.csv').replace('\\','/')
